...
import { FiCode, FiSmartphone, FiGlobe, FiTrendingUp, FiShield, FiZap, FiStar, FiAward, FiBarChart, FiClock } from 'react-icons/fi';

function ProjectIdeasPage() {
  const projects = [
    {
      title: "E-commerce Platform",
      description: "Build a full-stack e-commerce solution with modern tech stack including user authentication, payment processing, and admin dashboard.",
      difficulty: "Advanced",
      duration: "8-12 weeks",
    ...
    },
    {
      ...
      description: "Create a productivity tool with real-time updates, team collaboration, and advanced project tracking capabilities.",
    ...
    },
    {
      ...
      description: "Monitor and analyze social media metrics with beautiful charts, automated reporting, and cross-platform integration.",
      difficulty: "Advanced",
    ...
    },
    {
      ...
      description: "Develop an intelligent chatbot using modern AI APIs with natural language processing and context awareness.",
      difficulty: "Intermediate",
      duration: "4-6 weeks",
    ...
    },
    {
      ...
      description: "Build a comprehensive fitness application with workout planning, progress tracking, and social features.",
      difficulty: "Intermediate",
      duration: "6-10 weeks",
    ...
    },
    {
      ...
      description: "Create a beautiful weather application with location-based forecasts, historical data, and interactive maps.",
      difficulty: "Beginner",
      duration: "3-5 weeks",
    ...
    <div className="min-h-[89vh]  py-16 px-6 dark:from-black  relative overflow-hidden">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto leading-relaxed px-2">
            Transform your ideas into reality with these carefully curated project suggestions. Each project is designed to challenge your skills and build an impressive portfolio.
          </p>
        </motion.div>
        ...
        <div className="grid gap-6 sm:gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {projects.map((project, index) => (
            ...
            >
              <span className={`absolute top-4 right-4 px-3 py-1 bg-gradient-to-r ${project.color} text-white text-xs font-medium rounded-full shadow-md`}>
                {project.difficulty}
              </span>
              <div className={`w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br ${project.bgColor} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}>
                {project.icon}
              </div>
              ...
              <div className="mb-5 sm:mb-6">
                <div className="text-sm font-medium text-slate-700 dark:text-slate-200 mb-3">Tech Stack:</div>
              ...
              {/* Features */}
              <div className="mb-5 sm:mb-6">
                <div className="text-sm font-medium text-slate-700 dark:text-slate-200 mb-3">Key Features:</div>
                <div className="flex flex-wrap gap-2">
        ...
        >
          <div className="bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm rounded-3xl p-8 border border-white/20 dark:border-slate-700/20">
            ...
            <p className="text-slate-600 dark:text-slate-300 mb-6 max-w-2xl mx-auto">
              Choose a project that excites you and start building your portfolio. Remember, the best projects come from solving real problems and learning along the way.
            </p>
