...
const steps = [
  {
    ...
    hover:
      "hover:border-blue-400/50 hover:from-blue-500/30 hover:to-blue-600/30",
  },
  {
    ...
    hover:
      "hover:border-emerald-400/50 hover:from-emerald-500/30 hover:to-emerald-600/30",
  },
  {
    ...
    hover:
      "hover:border-purple-400/50 hover:from-purple-500/30 hover:to-purple-600/30",
  },
  {
    ...
    hover:
      "hover:border-amber-400/50 hover:from-amber-500/30 hover:to-amber-600/30",
  },
  {
    ...
    hover:
      "hover:border-green-400/50 hover:from-green-500/30 hover:to-green-600/30",
  },
  {
    ...
    hover:
      "hover:border-pink-400/50 hover:from-pink-500/30 hover:to-pink-600/30",
  },
];
  ...
  return (
    <div className="min-h-[89vh]   py-16 px-6 dark:bg-black relative overflow-hidden">
      ...
      >
        ...
        >
          Follow these 6 structured steps every time you solve a problem. Build
          your problem-solving muscle and become a coding champion.
        </motion.p>
      </motion.div>
      ...
      >
        ...
        <div className="grid  md:grid-cols-2 gap-6 text-slate-600 dark:text-slate-300">
          <div className="flex items-start sm:items-center sm:justify-center gap-3">
            ...
            <p>
              Practice consistently - even 30 minutes daily makes a huge
              difference
            </p>
          </div>
          <div className="flex items-start sm:items-center sm:justify-center gap-3">
